...
interface SiteChromeProps {
  ...
  /** Custom logo wrapper (e.g. <NavLink> in the SPA). When omitted, a plain anchor is used. */
  readonly logoLinkRender?: (children: ReactNode) => ReactNode;
...
export default function SiteChrome({
  ...
  const logoContent = <LogoMark />;
  const logo = logoLinkRender ? (
    logoLinkRender(logoContent)
  ) : (
